...
public class WrapperClassExamples {
    public static void main(String[] args) {
        ...
        String price = "$27.16";
        price = price.substring(1);// dolar işaretini attık
...
// Differenence between Integer.parseInt(str) and Integer.valueOf(str)
        ...
        Integer num2 = Integer.valueOf(str);//turn into wrapper class
        ...
        for(char each : strTwo.toCharArray()){
            if(Character.isDigit(each)){
                sumOfDigits+= Integer.parseInt(each+"");//each char stringe cevirmek için "" ekledik.
                // stringe cevirdikten sonra parseInt metodu kullandık
            }
        }

        System.out.println("sumOfDigits = " + sumOfDigits);//sumOfDigits = 6
