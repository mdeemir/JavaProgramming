...
public class ThrowKeyword2 {
    ...
    public static void main(String[] args) {
        ...
        //    throw new InterruptedException();---> henüz complier öngörecegi bir hata cıkmadan yazarsan yanı checked sınıfından bi nesne oluşturursan hata verir. çünkü henüz complier bi hata görmedi
