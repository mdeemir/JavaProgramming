...
//Arrays.asList("E", "F", "G" )   BU ŞEKLİLDE COLLECTİON TYPE ÇEVİRDİK
        System.out.println("-----------------------------------------------");
        /*
        Given:
        ...
        for (String each : new LinkedHashSet<>(Arrays.asList(str.split("")))) { //COLLECTİON TPE CEVİRDİK
            //ÖNCE SPLİT İLE ARRAY ELDE ETTİK SONRA ASLİST İLE COLLECTİONA CEVİRDİK
             result += each + Collections.frequency(  Arrays.asList(str.split("")) ,  each);
             //COOLECTİON UTİLİTY CLASSTAN FREQUENCY METODUNU KULLANDIK
        }
