...
public class CustomMethodsPractice {
    public static void main(String[] args) {
        ...
        helloWorld5Times(); // bu metoda ulaşmak istiyorsan yani kod blogunda ne var diye bakacaksan
        // üzerinde imleç yanıp sönerken control tusuna basıp üzerine tıklaman yeterli
