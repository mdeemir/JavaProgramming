...
public class StringMethods3_Substring {
    public static void main(String[] args) {
        ...
        String brand = word.substring(0, 4+1); //4 ü dahil etmiyor etmek için bir fazlasını yazacan

        System.out.println(brand);

        String str1 = word.substring(6);// 6. karakterden sonrasını yazdırmak istiyorsan sadece 6 yaz
